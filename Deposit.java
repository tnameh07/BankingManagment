...
public class Deposit extends JFrame implements ActionListener 
{
    ...
    String Accountno;
    int balance ;
    Deposit(String pin, String Accountno ,int balance) {
        this.pin = pin;
           ...
           balance +=amountx;
            ...
            if (ae.getSource() == b1) {
                if (t1.getText().equals("")) {
                    ...
                    // String query ="insert into WorldBank values('" + pin + "', '" + Accountno + "', '" + date + "', 'DipositAmount', '" + amount + "')" ;
                    String q ="UPDATE CutomerData SET Diposit = ? ,Balance= ? WHERE Account_no =? AND Ac_Password =?;";
                ...
                //    pstmt.setDate(2, java.sql.Date.valueOf());
                  ...
                  int rs=  pstmt.executeUpdate();
                    if(rs>0){
System.out.println("Data update succsed fully");
                    }
