...
public class Signup1 extends JFrame implements ActionListener{
    ...
    Signup1(){
       ...
       // setUndecorated(true);
        ...
        fnum = (Math.abs(ran.nextLong()%9L + 100L));
      ...
      try {
         if (name.equals("")) {
             ...
             String query ="INSERT INTO CutomerData (Form_no,Cust_name,Fname,Mname,DOB,Gender,E_mail,Marital_status,Address,City,State,Country) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        if(result>0)
{
    System.out.println("Data insert succusefully");
