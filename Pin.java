...
public class Pin extends JFrame implements ActionListener{
    ...
    String Accountno;
    int balance;
    Pin(String pin, String Accountno ,int balance){
        this.pin = pin;
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource()==b1){
                ...
                Connection c1 = Database.getInstance();
                String q3 = "update CutomerData set Ac_Password = '"+rpin+"' where Account_no = '" + Accountno +"' and Ac_Password = '" + pin + "'";

                PreparedStatement pstmt = c1.prepareStatement(q3);
                pstmt.executeUpdate();
             ...
             new Transactions(rpin,Accountno ,balance).setVisible(true);
