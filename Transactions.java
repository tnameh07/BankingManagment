...
public class Transactions extends JFrame implements ActionListener
{
  ...
  String Accountno;
  int balance ;
  Transactions(String pin, String Accountno, int balance)
  {
...
//    add(image3);
    ...
    l1 = new JLabel("Choose Your Action");
  ...
  public void actionPerformed(ActionEvent ae) { 
      ...
      if (ae.getSource() == b1) {
      setVisible(false);
      new Deposit(this.pin,this.Accountno , this.balance).setVisible(true);
      
    } else if (ae.getSource() == b2) {
      setVisible(false);
      new Withdrawl(this.pin,this.Accountno ,balance).setVisible(true);
    ...
    // } 
      ...
      new MiniStatement(this.pin,this.Accountno ,balance).setVisible(true);
      
    } else if (ae.getSource() == b5) {
      setVisible(false);
      new Pin(this.pin,this.Accountno , balance).setVisible(true);
      
    } else if (ae.getSource() == b6) {
      setVisible(false);
      new BalanceEnquiry(this.pin,this.Accountno ,balance).setVisible(true);
